...
from .views import OrdenMedicaAnonimaCreateView, OrdenesDelMedicoListView, editar_orden_modal, eliminar_orden_modal
...
urlpatterns = [
    ...
    path('orden/<int:pk>/eliminar-modal/', eliminar_orden_modal, name='orden_eliminar_modal'),
]
